...
import { reverseRevenueController } from './reverse-revenue/reverse-revenue.controller'
...
export async function revenueRoutes(app: FastifyInstance) {
  ...
  app.post('/revenue.reverse', authorize('AdminPanel', 'Financial', 'Revenues'), reverseRevenueController)
}
